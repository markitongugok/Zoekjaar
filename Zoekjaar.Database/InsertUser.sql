...
; WITH User_CTE (Id, Username, Salt, [Hash], UserType, IsActive) AS (
	...
	UNION SELECT 3, 'test.employer@zoekjaar.com', CONVERT(VARBINARY(8), '8B9EE2BAFB0C93F3', 2), CONVERT(VARBINARY(64), '253626BAE19B7DDE00C5A538AC8A9B07A48E59DE3A1D0CD7FC0D1F03EF0E980D7C7F11D2319C7301C16CB2C3365DCDF0F0051F0A443696975767CD977B5CD187', 2), 2, 1
) 
MERGE INTO dbo.[User]
